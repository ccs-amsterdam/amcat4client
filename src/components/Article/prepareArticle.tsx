import { AmcatArticle, AmcatAnnotation } from "@/interfaces";
import { getColor, getColorGradient } from "./colors";
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";

export default function prepareArticle(article: AmcatArticle) {
 ...
 * @returns
 */
const addAnnotations = (article: AmcatArticle) => {
